...
class ShutdownTest(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.lblCountdown = Gtk.Label("If no option is selected Autocode will automatically shutdown the system in 5 minutes...")
    ...
    def update_countdown(self):
        ...
        self.lblCountdown.set_label("If no option is selected Autocode will automatically shutdown the system in %s..." % str(datetime.timedelta(seconds=self.time)))
        if self.time <= 0:
            exit(0)
        return True
